                    ...
                    <S.BoardWrapper>
                        <S.BoardHeader>
                            <S.BoardInfo>
                                ...
                                <S.InfoWrapper>
                                    <S.InfoWriter>{props.data? props.data.fetchBoard.writer : "loading"}</S.InfoWriter>
                                    <S.InfoCreate>Date : {getDate(props.data? props.data.fetchBoard.createdAt : "loading")}</S.InfoCreate>
                                </S.InfoWrapper>
                            </S.BoardInfo>
                            <S.BoardFunction>
                        ...
                        <S.ContentTitle>{props.data? props.data.fetchBoard.title : "loading..."}</S.ContentTitle>
                        <S.ContentImg src="/detail/img.png"/>
                        <S.Content>{props.data? props.data.fetchBoard.contents : "loading"}</S.Content>
                        <S.VideoArea>
                        ...
                        <S.ContentEvaluationArea>
                            <S.ContentEvaluation>
                                <S.LIkeWrapper>
                                    ...
                                    <S.LikeCount>{props.data? props.data.fetchBoard.likeCount : "loading"}</S.LikeCount>
                                </S.LIkeWrapper>
                                <S.DisLIkeWrapper>
                                    <S.DisLikeImg src="/detail/dislike.png"></S.DisLikeImg>
                                    <S.DisLikeCount>{props.data? props.data.fetchBoard.dislikeCount : "loading"}</S.DisLikeCount>
                                </S.DisLIkeWrapper>
                            </S.ContentEvaluation>
                        </S.ContentEvaluationArea>
                    </S.BoardWrapper>
